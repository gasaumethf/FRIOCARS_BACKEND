...
// POST /api/clientes — solo nombre obligatorio
router.post('/', async (req, res) => {
    try {
        ...
        // Validar duplicado solo si viene documento
        if (numero_documento) {
        ...
        const result = await pool.query(`
            ...
            VALUES ($1, $2, $3, $4, $5, $6)
            RETURNING *
        `, [numero_documento || null, nombre, apellido || null, telefono || null, correo || null, direccion || null]);
...
router.put('/:id', async (req, res) => {
    try {
        ...
        const result = await pool.query(`
            ...
            WHERE id_cliente = $7
            RETURNING *
        `, [numero_documento || null, nombre, apellido || null, telefono || null, correo || null, direccion || null, id]);
